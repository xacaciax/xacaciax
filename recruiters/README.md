...
**Product-minded full-stack engineer with unusually deep Flutter, Supabase/Postgres, and applied-AI experience who can independently ship an entire product surface.**
...
## Ranked by demonstratable depth

| Rank | Technology / domain                         | Recruiter-safe level            | Why                                                                                                                                                                    |
| Rank | Skill | Level | Description |
| ---: | ----- | ----- | ----------- |
| 1 | **Flutter** | Expert | Has hipped and maintained cross-platform production applications across mobile and web. |
...
| 4 | **Dart** | Advanced | Their primary implementation language through extensive Flutter work, even if Claude now writes much of the syntax. |
| 5 | **System and product architecture** | Advanced | Probably stronger than their raw language fluency: decomposition, data flows, security boundaries, failure handling, platform design, and end-to-end product ownership. |
| 6 | **SQL** | Strong | Reasing about schemas, joins, grouping, filters, query behavior, permissions, and data integrity. |
| 7 | **TypeScript / JavaScript** | Strong working proficiency | Used across web, backend, serverless functions, integrations, and production tooling. Not positioned as a language specialist. |
...
| 11 | **React** | Working-to-strong proficiency | Enough production experience to own React/Next.js systems, but not their defining specialization. |
...
| 18 | **Python** | Working familiarity | Likely useful for scripts, evaluation, and data work, but not currently positioned as a primary production language. |
